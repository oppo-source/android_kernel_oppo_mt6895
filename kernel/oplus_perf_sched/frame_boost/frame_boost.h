...
extern int rt_stune_boost[BOOST_MAX_TYPE];

extern void util_systrace_c(unsigned long util, char *msg);
extern void cpus_systrace_c(unsigned int cpu, char *msg);
extern void fbg_sysctl_init(void);
