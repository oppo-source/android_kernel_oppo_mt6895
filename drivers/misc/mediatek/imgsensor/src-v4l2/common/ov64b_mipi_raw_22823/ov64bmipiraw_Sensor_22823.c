...
#include "ov64bmipiraw_Sensor_22823.h"
#include "ov64b_Sensor_setting_22823.h"
#include "ov64b_ana_gain_table_22823.h"
#include "ov64b_eeprom_22823.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV64B_SENSOR_ID_22823,
            ...
            ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
	...
	if(pStereodata != NULL) {
		...
		if ((pStereodata->uSensorId == OV64B_SENSOR_ID_22823) && (data_length == CALI_DATA_MASTER_LENGTH)
...
static void sensor_init(struct subdrv_ctx *ctx)
{
	...
	table_write_cmos_sensor(ctx,
		addr_data_pair_init_OV64B2q_22823,
		sizeof(addr_data_pair_init_OV64B2q_22823) / sizeof(kal_uint16));
	_is_initFlag = 1;
...
static void preview_setting(struct subdrv_ctx *ctx)
{
	...
	if (!_is_seamless) {
		_length = sizeof(addr_data_pair_preview_OV64B2q_22823) / sizeof(kal_uint16);
		table_write_cmos_sensor(ctx,
			addr_data_pair_preview_OV64B2q_22823,
			_length);
	} else {
		_length = sizeof(addr_data_pair_seamless_custom5_2_preview_OV64B2q_22823) / sizeof(kal_uint16);
		...
		memcpy((void *) (_i2c_data + _size_to_write),
			addr_data_pair_seamless_custom5_2_preview_OV64B2q_22823,
			sizeof(addr_data_pair_seamless_custom5_2_preview_OV64B2q_22823));
		_size_to_write += _length;
	}
	LOG_INF("%s end\n", __func__);
}
...
static void capture_setting(struct subdrv_ctx *ctx, kal_uint16 currefps)
{
	...
	_length = sizeof(addr_data_pair_capture_OV64B2q_22823) / sizeof(kal_uint16);
	if (!_is_seamless) {
		table_write_cmos_sensor(ctx,
			addr_data_pair_capture_OV64B2q_22823,
			_length);
	} else {
		LOG_INF("%s _is_seamless %d, _size_to_write %d\n",
			__func__, _is_seamless, _size_to_write);
		...
		memcpy((void *) (_i2c_data + _size_to_write),
			addr_data_pair_capture_OV64B2q_22823,
			sizeof(addr_data_pair_capture_OV64B2q_22823));
		_size_to_write += _length;
	}
...
static void normal_video_setting(struct subdrv_ctx *ctx, kal_uint16 currefps)
{
	...
	_length = sizeof(addr_data_pair_video_OV64B2q_22823) / sizeof(kal_uint16);
	if (!_is_seamless) {
		table_write_cmos_sensor(ctx,
			addr_data_pair_video_OV64B2q_22823,
			_length);
	} else {
		LOG_INF("%s _is_seamless %d, _size_to_write %d\n",
			__func__, _is_seamless, _size_to_write);
		...
		memcpy((void *) (_i2c_data + _size_to_write),
			addr_data_pair_video_OV64B2q_22823,
			sizeof(addr_data_pair_video_OV64B2q_22823));
		_size_to_write += _length;
	}
...
static void hs_video_setting(struct subdrv_ctx *ctx)
{
	...
	_length = sizeof(addr_data_pair_hs_video_OV64B2q_22823) / sizeof(kal_uint16);
	if (!_is_seamless) {
		table_write_cmos_sensor(ctx,
		addr_data_pair_hs_video_OV64B2q_22823,
		_length);
	} else {
		LOG_INF("%s _is_seamless %d, _size_to_write %d\n",
			__func__, _is_seamless, _size_to_write);
		...
		memcpy((void *) (_i2c_data + _size_to_write),
			addr_data_pair_hs_video_OV64B2q_22823,
			sizeof(addr_data_pair_hs_video_OV64B2q_22823));
		_size_to_write += _length;
	}
...
static void slim_video_setting(struct subdrv_ctx *ctx)
{
	...
	_length = sizeof(addr_data_pair_slim_video_OV64B2q_22823) / sizeof(kal_uint16);
	if (!_is_seamless) {
		table_write_cmos_sensor(ctx,
		addr_data_pair_slim_video_OV64B2q_22823,
		_length);
	} else {
		LOG_INF("%s _is_seamless %d, _size_to_write %d\n",
			__func__, _is_seamless, _size_to_write);
		...
		memcpy((void *) (_i2c_data + _size_to_write),
			addr_data_pair_slim_video_OV64B2q_22823,
			sizeof(addr_data_pair_slim_video_OV64B2q_22823));
		_size_to_write += _length;
	}
...
static void custom1_setting(struct subdrv_ctx *ctx)
{
	...
	LOG_INF("E\n");
	_length = sizeof(addr_data_pair_custom1_OV64B2q_22823) / sizeof(kal_uint16);
	if (!_is_seamless) {
		table_write_cmos_sensor(ctx,
		addr_data_pair_custom1_OV64B2q_22823,
		_length);
	} else {
		LOG_INF("%s _is_seamless %d, _size_to_write %d\n",
			__func__, _is_seamless, _size_to_write);
		...
		memcpy((void *) (_i2c_data + _size_to_write),
			addr_data_pair_custom1_OV64B2q_22823,
			sizeof(addr_data_pair_custom1_OV64B2q_22823));
		_size_to_write += _length;
	}
...
static void custom2_setting(struct subdrv_ctx *ctx)
{
	...
	LOG_INF("E\n");
	_length = sizeof(addr_data_pair_custom2_OV64B2q_22823) / sizeof(kal_uint16);
	if (!_is_seamless) {
		table_write_cmos_sensor(ctx,
		addr_data_pair_custom2_OV64B2q_22823,
		_length);
	} else {
		LOG_INF("%s _is_seamless %d, _size_to_write %d\n",
			__func__, _is_seamless, _size_to_write);
		...
		memcpy((void *) (_i2c_data + _size_to_write),
			addr_data_pair_custom2_OV64B2q_22823,
			sizeof(addr_data_pair_custom2_OV64B2q_22823));
		_size_to_write += _length;
	}
...
static void custom3_setting(struct subdrv_ctx *ctx)
{
	...
	LOG_INF("E\n");
	_length = sizeof(addr_data_pair_custom3_OV64B2q_22823) / sizeof(kal_uint16);
	if (!_is_seamless) {
		table_write_cmos_sensor(ctx,
		addr_data_pair_custom3_OV64B2q_22823,
		_length);
	} else {
		LOG_INF("%s _is_seamless %d, _size_to_write %d\n",
			__func__, _is_seamless, _size_to_write);
		...
		memcpy((void *) (_i2c_data + _size_to_write),
			addr_data_pair_custom3_OV64B2q_22823,
			sizeof(addr_data_pair_custom3_OV64B2q_22823));
		_size_to_write += _length;
	}
}	/*	custom3_setting  */
...
static void custom4_setting(struct subdrv_ctx *ctx)
{
	...
	_length = sizeof(addr_data_pair_custom4_OV64B2q_22823) / sizeof(kal_uint16);
	if (!_is_seamless) {
		table_write_cmos_sensor(ctx,
		addr_data_pair_custom4_OV64B2q_22823,
		_length);
	} else {
		LOG_INF("%s _is_seamless %d, _size_to_write %d\n",
			__func__, _is_seamless, _size_to_write);
		...
		memcpy((void *) (_i2c_data + _size_to_write),
			addr_data_pair_custom4_OV64B2q_22823,
			sizeof(addr_data_pair_custom4_OV64B2q_22823));
		_size_to_write += _length;
	}
...
static void custom5_setting(struct subdrv_ctx *ctx)
{
	...
	LOG_INF("E\n");
	if (!_is_seamless) {
		_length = sizeof(addr_data_pair_custom5_OV64B2q_22823) / sizeof(kal_uint16);
		table_write_cmos_sensor(ctx,
		addr_data_pair_custom5_OV64B2q_22823,
		_length);
	} else {
		_length = sizeof(addr_data_pair_seamless_preview_2_custom5_OV64B2q_22823) / sizeof(kal_uint16);
		LOG_INF("%s _is_seamless %d, _size_to_write %d\n",
			__func__, _is_seamless, _size_to_write);
		...
		memcpy((void *) (_i2c_data + _size_to_write),
			addr_data_pair_seamless_preview_2_custom5_OV64B2q_22823,
			sizeof(addr_data_pair_seamless_preview_2_custom5_OV64B2q_22823));
		_size_to_write += _length;
	}
}	/*	custom5_setting  */
...
static void custom6_setting(struct subdrv_ctx *ctx)
{
	...
	LOG_INF("E\n");
	_length = sizeof(addr_data_pair_custom6_OV64B2q_22823) / sizeof(kal_uint16);
	if (!_is_seamless) {
		table_write_cmos_sensor(ctx,
		addr_data_pair_custom6_OV64B2q_22823,
		_length);
	} else {
		LOG_INF("%s _is_seamless %d, _size_to_write %d\n",
			__func__, _is_seamless, _size_to_write);
		...
		memcpy((void *) (_i2c_data + _size_to_write),
			addr_data_pair_custom6_OV64B2q_22823,
			sizeof(addr_data_pair_custom6_OV64B2q_22823));
		_size_to_write += _length;
	}
...
static void custom7_setting(struct subdrv_ctx *ctx)
{
	...
	LOG_INF("E\n");
	_length = sizeof(addr_data_pair_custom7_OV64B2q_22823) / sizeof(kal_uint16);
	if (!_is_seamless) {
		table_write_cmos_sensor(ctx,
		addr_data_pair_custom7_OV64B2q_22823,
		_length);
	} else {
		LOG_INF("%s _is_seamless %d, _size_to_write %d\n",
			__func__, _is_seamless, _size_to_write);
		...
		memcpy((void *) (_i2c_data + _size_to_write),
			addr_data_pair_custom7_OV64B2q_22823,
			sizeof(addr_data_pair_custom7_OV64B2q_22823));
		_size_to_write += _length;
	}
...
static void custom8_setting(struct subdrv_ctx *ctx)
{
	...
	LOG_INF("E\n");
	_length = sizeof(addr_data_pair_custom8_OV64B2q_22823) / sizeof(kal_uint16);
	if (!_is_seamless) {
		table_write_cmos_sensor(ctx,
		addr_data_pair_custom8_OV64B2q_22823,
		_length);
	} else {
		LOG_INF("%s _is_seamless %d, _size_to_write %d\n",
			__func__, _is_seamless, _size_to_write);
		...
		memcpy((void *) (_i2c_data + _size_to_write),
			addr_data_pair_custom8_OV64B2q_22823,
			sizeof(addr_data_pair_custom8_OV64B2q_22823));
		_size_to_write += _length;
	}
...
static void custom9_setting(struct subdrv_ctx *ctx)
{
	...
	LOG_INF("E\n");
	_length = sizeof(addr_data_pair_custom9_OV64B2q_22823) / sizeof(kal_uint16);
	if (!_is_seamless) {
		table_write_cmos_sensor(ctx,
		addr_data_pair_custom9_OV64B2q_22823,
		_length);
	} else {
		LOG_INF("%s _is_seamless %d, _size_to_write %d\n",
			__func__, _is_seamless, _size_to_write);
		...
		memcpy((void *) (_i2c_data + _size_to_write),
			addr_data_pair_custom9_OV64B2q_22823,
			sizeof(addr_data_pair_custom9_OV64B2q_22823));
		_size_to_write += _length;
	}
...
static void custom10_setting(struct subdrv_ctx *ctx)
{
	...
	LOG_INF("E\n");
	_length = sizeof(addr_data_pair_custom10_OV64B2q_22823) / sizeof(kal_uint16);
	if (!_is_seamless) {
		table_write_cmos_sensor(ctx,
		addr_data_pair_custom10_OV64B2q_22823,
		_length);
	} else {
		LOG_INF("%s _is_seamless %d, _size_to_write %d\n",
			__func__, _is_seamless, _size_to_write);
		...
		memcpy((void *) (_i2c_data + _size_to_write),
			addr_data_pair_custom10_OV64B2q_22823,
			sizeof(addr_data_pair_custom10_OV64B2q_22823));
		_size_to_write += _length;
...
//
//	LOG_INF("E\n");
//	_length = sizeof(addr_data_pair_custom11_OV64B2q_22823) / sizeof(kal_uint16);
//	if (!_is_seamless) {
//		table_write_cmos_sensor(ctx,
//		addr_data_pair_custom11_OV64B2q_22823,
//		_length);
//	} else {
//		LOG_INF("%s _is_seamless %d, _size_to_write %d\n",
//			__func__, _is_seamless, _size_to_write);
...
//		memcpy((void *) (_i2c_data + _size_to_write),
//			addr_data_pair_custom11_OV64B2q_22823,
//			sizeof(addr_data_pair_custom11_OV64B2q_22823));
//		_size_to_write += _length;
//		_i2c_data[_size_to_write++] = 0x5001;
//		_i2c_data[_size_to_write++] = 0x3;
//	}
...
//
//	LOG_INF("E\n");
//	_length = sizeof(addr_data_pair_custom12_OV64B2q_22823) / sizeof(kal_uint16);
//	if (!_is_seamless) {
//		table_write_cmos_sensor(ctx,
//		addr_data_pair_custom12_OV64B2q_22823,
//		_length);
//	} else {
//		LOG_INF("%s _is_seamless %d, _size_to_write %d\n",
//			__func__, _is_seamless, _size_to_write);
...
//		memcpy((void *) (_i2c_data + _size_to_write),
//			addr_data_pair_custom12_OV64B2q_22823,
//			sizeof(addr_data_pair_custom12_OV64B2q_22823));
//		_size_to_write += _length;
//		_i2c_data[_size_to_write++] = 0x5001;
//		_i2c_data[_size_to_write++] = 0x3;
//	}
...
static void read_module_data(struct subdrv_ctx *ctx)
{
    kal_uint16 idx = 0;
    kal_uint32 Dac_master = 0, Dac_mac = 0, Dac_inf = 0;
    read_ov64b_eeprom_info_22823(ctx, EEPROM_META_MODULE_ID,
                &(ov64b_common_data[0]), 2);
    read_ov64b_eeprom_info_22823(ctx, EEPROM_META_SENSOR_ID,
                &(ov64b_common_data[2]), 2);
    read_ov64b_eeprom_info_22823(ctx, EEPROM_META_LENS_ID,
                &(ov64b_common_data[4]), 2);
    read_ov64b_eeprom_info_22823(ctx, EEPROM_META_VCM_ID,
                &(ov64b_common_data[6]), 2);
    read_ov64b_eeprom_info_22823(ctx, EEPROM_META_MODULE_SN,
                &(ov64b_common_data[8]), 17);
    read_ov64b_eeprom_info_22823(ctx, EEPROM_META_AF_CODE,
	...
	kal_uint32 shutter_2ndframe, kal_uint32 gain_2ndframe)
{
	...
	_length = sizeof(addr_data_pair_seamless_switch_step1_OV64B2q_22823) / sizeof(kal_uint16);
	...
	memcpy((void *)(_i2c_data + _size_to_write),
		addr_data_pair_seamless_switch_step1_OV64B2q_22823,
		sizeof(addr_data_pair_seamless_switch_step1_OV64B2q_22823));
	_size_to_write += _length;
	...
	_length = sizeof(addr_data_pair_seamless_switch_step2_OV64B2q_22823) / sizeof(kal_uint16);
	...
	memcpy((void *)(_i2c_data + _size_to_write),
		addr_data_pair_seamless_switch_step2_OV64B2q_22823,
		sizeof(addr_data_pair_seamless_switch_step2_OV64B2q_22823));
	_size_to_write += _length;
	...
	_length = sizeof(addr_data_pair_seamless_switch_step3_OV64B2q_22823) / sizeof(kal_uint16);
	if (_size_to_write + _length > _I2C_BUF_SIZE) {
		LOG_INF("_too much i2c data for fast siwtch\n");
		return ERROR_NONE;
	}
	memcpy((void *)(_i2c_data + _size_to_write),
		addr_data_pair_seamless_switch_step3_OV64B2q_22823,
		sizeof(addr_data_pair_seamless_switch_step3_OV64B2q_22823));
	_size_to_write += _length;
...
const struct subdrv_entry ov64b_mipi_raw_22823_entry = {
	.name = "ov64b_mipi_raw_22823",
	.id = OV64B_SENSOR_ID_22823,
	.pw_seq = pw_seq,
